...
@endif
    ...
    <form method="POST" action="{{ route('change-password') }}">
        ...
        <div class="form-group mb-4">
            ...
            <input id="current_password" type="password" name="current_password" class="form-control" placeholder="Current Password" style="width:50%;" >
...
<div class="form-group mb-4">
                                        <div class="password-container" style="position: relative;">
                                        <input id="new_password" type="password" name="new_password" class="form-control" style="width: 50%;" placeholder="New Password">
...
<div class="form-group mb-4">
                                        <div class="password-container" style="position: relative;">
                                        <input id="new_password_confirmation" type="password" name="new_password_confirmation" class="form-control" style="width: 50%;" placeholder="Confirm Password">
