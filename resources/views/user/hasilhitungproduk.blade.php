...
<div class="row mt-2">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Target Poin</h5>
                <input class="form-control font-weight-bold" style="font-weight: bold;" type="text" value="{{$totalPoin}} poin" aria-label="0 poin" disabled>
            </div>
        </div>
    </div>
</div>
