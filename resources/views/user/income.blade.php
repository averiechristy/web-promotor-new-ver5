...
@foreach ($produk as $detail)
  <div class="col">
    ...
    <hr>
     <div class="card-body">
        <h5 class="card-title" style="text-align:center;">{{ $detail->qty_produk }} {{ $detail->produk->nama_produk }}</h5>
        <p class="card-text"  style="text-align:center;">{{ $detail->produk->deskripsi_produk }} </p>
      </div>
    </div>
  </div>
