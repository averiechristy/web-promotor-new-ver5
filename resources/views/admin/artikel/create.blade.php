                                    ...
                                    <div class="card-body">
                                       <form action="{{route('admin.artikel.simpan')}}" method="post"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input name="judul_artikel" type="text" class="form-control {{$errors->has('judul_artikel') ? 'is-invalid' : ''}}"  style="border-color: #01004C;" value="{{old('judul_artikel')}}" />
                                            ...
                                            <div class="form-group">
                                                  ...
                                                  <input  name="gambar_artikel" type="file"  class="form-control-file {{$errors->has('gambar_artikel') ? 'is-invalid' : ''}}"  style="border-color: #01004C;" value="{{old('gambar_artikel')}}" >
                                              ...
                                              <div class="form-group">
                                              <textarea name="isi_artikel"  class="my-editor form-control {{$errors->has('isi_artikel') ? 'is-invalid' : ''}}"  style="border-color: #01004C;"  id="my-editor" cols="30" rows="10"> {{old('isi_artikel')}}</textarea>                                             </div>
